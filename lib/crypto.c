...
/**
  *     @brief  Compute a derived AES-256 key from the intersection of a private ephemeral EC key and another public EC key.
  *     @param  key
  *     @param  ephemeral
  *     @param  keybuf
  *     return
